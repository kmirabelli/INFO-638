...
$query = "SELECT sched_date, title, image_path, servings, cook_time, estimated_cost FROM schedule NATURAL JOIN recipes";
...
while ($row = $result->fetch_assoc()) {
    ...
    echo "</div>";
    echo "<div class='tile'>";
	echo "<img width='400px' alt='recipe photo' src='";
    echo $row['image_path'];
    echo "'/> ";
    echo "<br>";
    echo "<b>";

...
$query = "SELECT recipe_id, title, image_path, servings, cook_time, estimated_cost, diet_name FROM favorites NATURAL JOIN recipes NATURAL JOIN diets ORDER BY title asc";

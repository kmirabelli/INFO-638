...
$query = "SELECT DATE_FORMAT(sched_date, \"%W, %M %e, %Y\") as 'sched_date', recipe_id, title, image_path, servings, cook_time, estimated_cost, diet_name FROM schedule NATURAL JOIN recipes NATURAL JOIN diets";
